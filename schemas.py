...
class Player(Document):
    ...
    location_city = StringField(max_lenght=50, help_text="Parsed city information")
    location_state = StringField(max_lenght=50, help_text="Parsed state information")
    location_country = StringField(max_lenght=50, help_text="Parsed country information")
    ...
    membership_status = StringField(max_lenght=25, help_text="Active/Inactive/Special memberships ie. Eagle club")
