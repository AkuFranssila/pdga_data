...
def RunPlayerRawDataParse(file_date):
    ...
    all_file_keys = find_all_keys_from_s3_folder(f"player-raw-data/{file_date}")
    ...
    for file_key in all_file_keys:
        ...
        save_to_temp_file_and_upload_to_s3("player-parsed-data", file_date, file_counter, all_parsed_data)
